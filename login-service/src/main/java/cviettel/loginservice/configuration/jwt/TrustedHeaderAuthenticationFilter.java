...
//        // Nếu request thuộc các đường dẫn Swagger, bỏ qua filter
//        if (path.startsWith(request.getContextPath() + "/auth/swagger-ui") ||
//                path.startsWith(request.getContextPath() + "/auth/v3/api-docs")) {
